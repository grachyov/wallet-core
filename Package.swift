...
let package = Package(
    ...
    products: [
        ...
        .library(name: "VSwiftProtobuf", targets: ["VSwiftProtobuf"])
    ],
    dependencies: [],
    targets: [
        .binaryTarget(
        ...
        .binaryTarget(
            name: "VSwiftProtobuf",
            url: "https://github.com/trustwallet/wallet-core/releases/download/4.1.21/VSwiftProtobuf.xcframework.zip",
